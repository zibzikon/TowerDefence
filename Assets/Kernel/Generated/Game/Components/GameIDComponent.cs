...
public partial class GameEntity {
    ...
    public Kernel.Components.ID iD { get { return (Kernel.Components.ID)GetComponent(GameComponentsLookup.ID); } }
    ...
    public void AddID(int newValue) {
        ...
        var component = (Kernel.Components.ID)CreateComponent(index, typeof(Kernel.Components.ID));
