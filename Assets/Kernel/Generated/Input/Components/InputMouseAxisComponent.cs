...
public partial class InputEntity {
    ...
    public Kernel.Components.MouseAxis mouseAxis { get { return (Kernel.Components.MouseAxis)GetComponent(InputComponentsLookup.MouseAxis); } }
    public bool hasMouseAxis { get { return HasComponent(InputComponentsLookup.MouseAxis); } }

    public void AddMouseAxis(UnityEngine.Vector2 newValue) {
        var index = InputComponentsLookup.MouseAxis;
        var component = (Kernel.Components.MouseAxis)CreateComponent(index, typeof(Kernel.Components.MouseAxis));
